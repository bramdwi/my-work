...
export default function Contact() {
  ...
  return (
    <div id="contact" className="bg-gray-50">
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
        <div className="relative bg-white shadow-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            {/* Contact information */}
            <div className="relative overflow-hidden py-10 px-6 bg-gradient-to-b from-primary to-primary-dark sm:px-10 xl:p-12">
              ...
              <dl className="mt-8 space-y-6">
                ...
                <dd className="flex text-base text-indigo-50">
                  ...
                  <span className="ml-3">support@logitech.com</span>
                </dd>
              </dl>
            ...
            <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                ...
                <div className="sm:col-span-2">
                  <Button type="submit" disabled={isSubmitting} className="w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
      ...
      {toasts.map((t) => (
        <ToastComponent key={t.id} toast={t} onDismiss={dismissToast} />
      ))}
    </div>
  );
}